...
delays_ms_24 = [35.6533, 25.0249, 39.0689, 35.6533,30.1243, 45.3497, 30.2934, 27.3612, 64.1165]
...
text = ['DDR-L:DDR-R=','DDR-L:CXL-ASIC=','DDR-L:CXL-FPGA=']
labels = [
    "Cfg1. 100%:0%",
    "Cfg4. 100%:0%",
    "Cfg7. 100%:0%",
...
# plt.text(-2.087, 10.9, text[1], fontsize=40)
# plt.text(-2.67, 9.5, text[2],fontsize=40)
...
#
# version 4
plt.text(-2.57, 12.33, text[0],fontsize=40)
plt.text(-2.57, 10.93, text[1], fontsize=40)
plt.text(-2.57, 9.53, text[2],fontsize=40)
...
axs[0].legend(labels, bbox_to_anchor=(2.3, 1.55), frameon=False, ncol=3, fontsize=40, edgecolor='black',fancybox=False,borderpad = 0.2, labelspacing = 0.2, handletextpad = 0.3,columnspacing=0.5) # 图例放在最下方


# 取消savefig保存图片时的白色边框 pad_inches参数
plt.savefig('merci_graduation.pdf', bbox_inches='tight', pad_inches=0.0)
# plt.show()
